...
#define FAST_MEMORY_SIZE (64L * (1024L * 1024L * 1024L)) // size of fast tier memory in bytes
...
void* perf_func(void*) {
    ...
    uint32_t sample_size = 10000000;
    std::cout << "perf LFU tierng. ASPLOS 25, only freq CBF, sample size " << sample_size << std::endl;
